...
if __name__ == "__main__":
    ...
    print("After handling missing values:", df_clean.shape)
    
    df_no_outliers = remove_outliers_iqr(df_clean, 'feature_a')
    print("After removing outliers:", df_no_outliers.shape)
    
    df_no_outliers['feature_a_normalized'] = normalize_minmax(df_no_outliers, 'feature_a')
    df_no_outliers['feature_a_standardized'] = standardize_zscore(df_no_outliers, 'feature_a')
