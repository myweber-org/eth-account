...
def clean_csv_data(file_path, output_path=None, fill_method='mean'):
    ...
    Args:
        ...
        fill_method: Method for filling missing values ('mean', 'median', 'mode', 'drop')
...
if __name__ == "__main__":
    ...
    cleaned_data, statistics = process_dataframe(sample_data, ['values'])
    
    print("Cleaned data shape:", cleaned_data.shape)
    print("\nStatistics for 'values' column:")
    print(f"Original count: {statistics['values']['original']['count']}")
    print(f"Cleaned count: {statistics['values']['cleaned']['count']}")
    print(f"Outliers removed: {statistics['values']['removed_count']}")