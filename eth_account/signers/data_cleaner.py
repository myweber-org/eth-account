...
def handle_missing_values(df, strategy='mean', columns=None):
    ...
    columns (list): List of columns to apply the strategy to, None for all columns
...
def remove_outliers_iqr(df, columns=None, threshold=1.5):
    ...
    Parameters:
    df (pd.DataFrame): Input DataFrame
    columns (list): List of columns to check for outliers, None for all numeric columns
