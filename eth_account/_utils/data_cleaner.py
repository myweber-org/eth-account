...
if __name__ == "__main__":
    ...
    print("Original data shape:", df.shape)
    print("\nOriginal statistics:")
    stats_original = calculate_statistics(df)
    for col, values in stats_original.items():
        print(f"{col}: {values}")
    ...
    print("\nCleaned data shape:", cleaned_df.shape)
    print("\nCleaned statistics:")
    stats_cleaned = calculate_statistics(cleaned_df)
    for col, values in stats_cleaned.items():
        print(f"{col}: {values}")
