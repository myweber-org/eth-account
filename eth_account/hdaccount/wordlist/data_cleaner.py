...
if __name__ == "__main__":
    ...
    print("Missing values after handling:", cleaner.get_summary()['missing_values'])
    ...
    print(f"Final dataset: {final_summary['current_rows']} rows, {final_summary['columns']} columns")
import pandas as pd
import re
...
def get_data_summary(df):
    """
    Generate a summary of the DataFrame including shape and missing values.
