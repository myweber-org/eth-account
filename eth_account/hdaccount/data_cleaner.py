...
def clean_dataset(data, numeric_columns, outlier_method='iqr', normalize_method='minmax'):
    ...
    for column in numeric_columns:
        ...
        cleaning_report[f'{column}_outliers_removed'] = removed
...
def validate_data(data, required_columns, numeric_threshold=0.8):
    ...
    validation_results['numeric_ratio'] = numeric_ratio
    validation_results['numeric_sufficient'] = numeric_ratio >= numeric_threshold
...
def remove_outliers(df, columns=None, method='iqr', threshold=1.5):
    """
    Remove outliers from specified columns using different methods.
...
def process_dataframe(df, numeric_columns):
    """
    Process DataFrame by cleaning outliers and normalizing specified columns.
    ...
    for column in numeric_columns:
        if column in processed_df.columns:
            ...
            # Print statistics
            stats = calculate_basic_stats(processed_df, column)
...
if __name__ == "__main__":
    ...
    processed_df = process_dataframe(df, ['value', 'score'])
...
if __name__ == "__main__":
    ...
    outlier_report, outliers = detect_outliers_iqr(cleaned_df, 'C')
    print("\nOutlier Report:")
