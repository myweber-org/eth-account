...
class DataCleaner:
    ...
    def get_summary(self):
        summary = {
            ...
            'numeric_stats': self.df[self.numeric_columns].describe().to_dict() if len(self.numeric_columns) > 0 else {},
            'categorical_counts': {col: self.df[col].value_counts().to_dict() for col in self.categorical_columns}
        }
        return summary
