...
def clean_dataset(df, missing_strategy='mean', normalize_columns=None, remove_outliers=False):
    """
    ...
    if remove_outliers:
        ...
        for col in numeric_cols:
            outlier_df = detect_outliers(df_clean, col)
            df_clean = df_clean[~outlier_df['is_outlier']]
