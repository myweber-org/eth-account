...
if __name__ == "__main__":
    ...
    df.loc[20, 'B'] = 1000  # Add another outlier
...
def remove_duplicates(input_file, output_file, key_columns):
    """
    Remove duplicate rows from CSV based on specified key columns.
    """
    seen = set()
    unique_rows = []
    ...
    with open(input_file, 'r', newline='', encoding='utf-8') as infile:
        ...
        for row in reader:
            ...
            key_tuple = tuple(str(row[col]) for col in key_columns)
    ...
    return len(unique_rows)import pandas as pd
