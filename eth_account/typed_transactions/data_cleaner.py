...
if __name__ == "__main__":
    ...
    print(f"Data cleaning complete. Shape: {cleaned_data.shape}")import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    sample_data = pd.DataFrame({
        ...
        'feature_b': np.random.exponential(scale=2.0, size=100),
...
if __name__ == "__main__":
    result = example_usage()import numpy as np
import pandas as pd
