...
class DataCleaner:
    ...
    def get_removed_count(self):
        return self.original_shape[0] - len(self.df)
...
def create_sample_data():
    ...
    df.loc[outliers, 'feature1'] = np.random.uniform(300, 500, 50)
    df.loc[outliers[:25], 'feature2'] = np.random.uniform(400, 600, 25)
    
    missing_indices = np.random.randint(0, 1000, 100)
    df.loc[missing_indices, 'feature3'] = np.nan
...
if __name__ == "__main__":
    ...
    print(f"\nRemoved {removed_iqr} outliers using IQR method")
