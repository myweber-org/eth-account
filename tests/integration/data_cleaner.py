...
if __name__ == "__main__":
    ...
    report = validate_cleaning(sample_data, cleaned_data, ['feature_a', 'feature_b', 'feature_c'])
    ...
    for col, stats in report.items():
        ...
        print(f"  Original std: {stats['original']['std']:.2f}")
        print(f"  Cleaned std: {stats['cleaned']['std']:.2f}")import pandas as pd
import numpy as np
...
if __name__ == "__main__":
    ...
    is_valid = validate_dataframe(cleaned, required_columns=['id', 'name', 'age'], min_rows=1)
