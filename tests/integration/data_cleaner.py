...
def validate_cleaned_data(df):
    """
    Validate that the cleaned DataFrame has no nulls or duplicates.
    ...
    return null_check and duplicate_check
...
if __name__ == "__main__":
    ...
    print("\nCleaned DataFrame:")
    print(cleaned)
    print("\nValidation passed:", validate_cleaned_data(cleaned))import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    print("Column ranges after normalization:")
    for col in ['A', 'B', 'C']:
