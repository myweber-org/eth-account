...
def validate_email_column(df, email_column):
    ...
    Returns:
        DataFrame with valid emails and validation results
    """
    ...
    valid_emails = df[df['email_valid']]
...
if __name__ == "__main__":
    ...
    is_valid = validate_dataframe(cleaned, required_columns=['id', 'value'], numeric_columns=['id', 'value'])
