...
if __name__ == "__main__":
    ...
    print(final_validation)import pandas as pd
import numpy as np
from scipy import stats
...
def clean_dataset(df, missing_strategy='mean', outlier_method=None, outlier_threshold=3):
    cleaner = DataCleaner(df)
    cleaner.handle_missing_values(strategy=missing_strategy)
    
    if outlier_method:
        cleaner.remove_outliers(method=outlier_method, threshold=outlier_threshold)
