...
def main():
    ...
    is_valid, message = validate_dataframe(df_cleaned, required_columns=['id', 'name'])
...
if __name__ == "__main__":
    ...
    # Add some outliers
    data['temperature'][0] = 100  # Extreme high outlier
    data['temperature'][1] = -10  # Extreme low outlier
    data['humidity'][2] = 200     # Extreme high outlier
...
if __name__ == "__main__":
    sample_data = {
        'values': [10, 12, 12, 13, 12, 11, 14, 13, 15, 100, 12, 13, 12, 11, 10, 14, 13, 12, 11, 15]
    }
