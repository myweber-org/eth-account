...
def validate_data(data, required_columns=None, allow_nan=False):
    ...
    if not allow_nan:
        ...
        if columns_with_nan:
            validation_report['issues'].append(f"Columns with NaN values: {columns_with_nan}")
            validation_report['summary']['nan_counts'] = nan_counts.to_dict()
    
    validation_report['summary']['shape'] = data.shape
    validation_report['summary']['dtypes'] = data.dtypes.to_dict()
