...
if __name__ == "__main__":
    cleaned_df = clean_dataset('sample_data.csv', outlier_method='zscore', normalize_method='zscore')
    cleaned_df.to_csv('cleaned_data.csv', index=False)
    print(f"Data cleaned and saved. Original shape: {pd.read_csv('sample_data.csv').shape}, Cleaned shape: {cleaned_df.shape}")