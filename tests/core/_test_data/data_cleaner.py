...
if __name__ == "__main__":
    ...
    cleaned_df, original_stats, cleaned_stats = process_dataset(df, 'values')
...
if __name__ == "__main__":
    ...
    normalized = normalize_data(cleaned, columns=['A', 'B'], method='minmax')
...
def validate_dataframe(df):
    required_checks = [
        ...
        ('numeric_cols_exist', len(df.select_dtypes(include=[np.number]).columns) > 0),
        ('positive_rows', len(df) > 0)
    ]
...
if __name__ == "__main__":
    ...
    data = {
        ...
        'pressure': [1013, 1014, 1015, 1016, 1017, 1018, 1019, 1020, 1500, 1021, 900]
    }
