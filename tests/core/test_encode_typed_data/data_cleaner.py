...
def validate_email_column(df, email_column):
    ...
    Args:
        df (pd.DataFrame): DataFrame containing email column
...
if __name__ == "__main__":
    ...
    remove_duplicates("cleaned_data.csv", "final_data.csv")import pandas as pd
import numpy as np
...
def calculate_statistics(df):
    ...
    return pd.DataFrame(stats)import pandas as pd
import numpy as np
